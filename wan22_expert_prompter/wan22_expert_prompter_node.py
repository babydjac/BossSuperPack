...
class WAN22ExpertPrompterNode:
    ...
    def _build_context_prompt(self, user_idea, complexity, style, motion, camera, lighting, color, shot, time_of_day, subject, environment, mood, tech_specs):
    ...
    def generate_expert_prompt(self, user_idea, api_key, prompt_complexity, style_preference,
        ...
        context_prompt = self._build_context_prompt(
            user_idea, prompt_complexity, style_preference, motion_intensity,
